...
*Open vraag: is er behoefte aan een tussenrol zoals "L&D-coördinator" die trainers begeleidt maar geen volledige systeembeheerder is? Zie hoofdstuk 9.*
...
| AI-tutor/coach *(mogelijke latere fase)* | Learner | Beantwoordt vragen over lesinhoud tijdens het leren, vergelijkbaar met functionaliteit die onderzochte platformen bieden |
