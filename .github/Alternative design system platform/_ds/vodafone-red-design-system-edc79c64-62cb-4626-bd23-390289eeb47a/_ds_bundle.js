...
(() => {
	...
	try {
		(() => {
			 ...
			 */
			function SpeechmarkOrb({ size = 48, style = {}, title = "Vodafone", ...rest }) {
		...
		__ds_ns.__errors.push({ path: "components/brand/SpeechmarkOrb.jsx", error: String((e && e.message) || e) });
	}
	...
	try {
		(() => {
			...
			function Badge({ children, style = {}, ...rest }) {
				return /*#__PURE__*/ React.createElement(
					"span",
					_extends(
						{
		...
		__ds_ns.__errors.push({ path: "components/core/Badge.jsx", error: String((e && e.message) || e) });
	}
	...
	try {
		(() => {
			 ...
			 */
			function Card({ image, imageAlt = "", tag, title, caption, lead = false, children, style = {}, ...rest }) {
				return /*#__PURE__*/ React.createElement(
					"article",
					_extends(
						{
					...
					/*#__PURE__*/ React.createElement(
						...
						tag &&
							/*#__PURE__*/ React.createElement(
								"div",
								null,
								/*#__PURE__*/ React.createElement(__ds_scope.Badge, null, tag)
							),
						title &&
							/*#__PURE__*/ React.createElement(
								"h3",
	...
	try {
		(() => {
			 ...
			 */
			function IconButton({ size = 48, ariaLabel, children, style = {}, ...rest }) {
				return /*#__PURE__*/ React.createElement(
					"button",
					_extends(
						{
		...
		__ds_ns.__errors.push({ path: "components/core/IconButton.jsx", error: String((e && e.message) || e) });
	}
	...
	try {
		(() => {
			...
			function Input({ label, hint, id, type = "text", style = {}, invalid = false, ...rest }) {
		...
		__ds_ns.__errors.push({ path: "components/core/Input.jsx", error: String((e && e.message) || e) });
	}
	...
	try {
		(() => {
			...
			function NavBar({ links = [], cta, style = {}, ...rest }) {
				return /*#__PURE__*/ React.createElement(
					"nav",
					_extends(
						{
   ...
   Exposes sections on window for index.html to mount. */
			...
			const { Button, IconButton, Badge, Card, SpeechmarkOrb, Input } = VF;

			/* ── Top nav with working search + account overlays ── */
			function SiteNav({ onSearch, onAccount }) {
				...
				return /*#__PURE__*/ React.createElement(
					...
					/*#__PURE__*/ React.createElement(
						...
						/*#__PURE__*/ React.createElement(
							...
							"Our biggest network upgrade yet brings faster 5G to more places than ever."
						),
						/*#__PURE__*/ React.createElement(
							"div",
							{
			...
			function AccountOverlay({ onClose }) {
				return /*#__PURE__*/ React.createElement(
					"div",
					{
						onClick: onClose,
		...
		__ds_ns.__errors.push({ path: "ui_kits/marketing/sections.jsx", error: String((e && e.message) || e) });
	}
